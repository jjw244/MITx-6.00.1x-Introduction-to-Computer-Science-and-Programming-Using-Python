...
def isValidWord(word, hand, wordList):
    ...
    hand_copy = hand.copy()
    for l in word:
        if l in hand and hand_copy[l] != 0:
            hand_copy[l] -= 1
        else:
            return False
    if word in wordList and l in hand_copy:
        return True
    else:
        return False
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while max(hand.values()) != 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            print("Invlaid word, please try again")
    ...
    if max(hand.values()) == 0:
        print("You are out of letters.  Total score: " +  str(totalScore) + " points")
    else:
